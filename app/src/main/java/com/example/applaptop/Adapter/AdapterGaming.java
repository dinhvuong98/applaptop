...
public class AdapterGaming extends RecyclerView.Adapter<AdapterGaming.ViewHolder>{
    private ArrayList<LapTop> list;
    private Context context;

    public AdapterGaming(ArrayList<LapTop> list, Context context) {
        this.list = list;
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View item = li.inflate(R.layout.item_laptop_gaming,parent,false);
